...
namespace CoreLib.CORE.Helpers.StringHelpers.Parsers
{
    ...
    {
        /// <summary>
        /// Словарь сокращений для адресных единиц
        /// </summary>
        ...
        /// <summary>
        /// Словарь коррекций для адресных единиц
        /// </summary>
        ...
        /// <summary>
        /// Словарь коррекции для окончаний
        /// </summary>
        ...
        /// <summary>
        /// Инвертирует написание адреса. Работает, если все адресные позиции перечислены через запятую
        /// </summary>
        /// <param name="source">Адрес для инверсии</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Форматирует адрес. Работает, если все адресные позиции перечислены через запятую
        /// </summary>
        /// <param name="source">Адрес, который нужно отформатировать</param>
        /// <returns>Отформатированный адрес</returns>
        public static string FormatAddress(string source)
        {
            ...
            foreach (var e in AddressEndingsDictionary)
            {
                source = source.Replace(e.Key, e.Value);
            }
