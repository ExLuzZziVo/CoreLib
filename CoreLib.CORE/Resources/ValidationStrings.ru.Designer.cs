...
namespace CoreLib.CORE.Resources {
    ...
    public class ValidationStrings_ru {
        ...
        public static string FileMaxSizeError {
            get {
                return ResourceManager.GetString("FileMaxSizeError", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Размер файла &apos;{0}&apos; должен быть больше {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Размер файла &apos;{0}&apos; должен быть не менее {1} и не более {2}.
        /// </summary>
        public static string FileRangeSizeError {
            get {
                return ResourceManager.GetString("FileRangeSizeError", resourceCulture);
            }
        }
